...
const ReorientForm = ({ analysisOptions, readOnly, setOption }) => {
  ...
  return (
    <Form layout="vertical">
      ...
      <FormItem label="rotation about x axis (pitch) in degrees (-360,360)" {...formItemLayout}>
        <InputNumber
      ...
      <FormItem label="rotation about y axis (roll) in degrees (-360,360)" {...formItemLayout}>
        <InputNumber
      ...
      <FormItem label="rotation about z axis (yaw) in degrees (-360,360)" {...formItemLayout}>
        <InputNumber
